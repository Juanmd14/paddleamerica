...
- **Puntos de un torneo:** en _Torneos → Inscripciones_, “Planilla de puntos” baja un Excel solo con los jugadores de las parejas confirmadas (los que están en el ranking). Se completa y se sube en Carga de puntos.
